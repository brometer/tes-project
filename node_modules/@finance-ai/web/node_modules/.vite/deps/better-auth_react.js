  ...
  const triggerRefetch = (event) => {
    ...
    const fetchSessionWithRefresh = () => {
      ...
      $fetch("/get-session").then(async (res) => {
        ...
        const sessionData = (data == null ? void 0 : data.session) && (data == null ? void 0 : data.user) ? {
    ...
    if ((currentSession == null ? void 0 : currentSession.data) === null || (currentSession == null ? void 0 : currentSession.data) === void 0) {
      state.lastSync = now2();
      sessionSignal.set(!sessionSignal.get());
    }
  };
